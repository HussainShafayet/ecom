...
//            <ul className="space-y-2">
//              <li><a href="#" className="hover:text-gray-100">Support Center</a></li>
//              <li><a href="#" className="hover:text-gray-100">FAQ</a></li>
//              <li><a href="#" className="hover:text-gray-100">Return Policy</a></li>
//              <li><a href="#" className="hover:text-gray-100">Shipping Info</a></li>
//            </ul>
//          </div>
...
//            <ul className="space-y-2">
//              <li><a href="#" className="hover:text-gray-100">Login</a></li>
//              <li><a href="#" className="hover:text-gray-100">Order Tracking</a></li>
//              <li><a href="#" className="hover:text-gray-100">Wish List</a></li>
//              <li><a href="#" className="hover:text-gray-100">Shopping Cart</a></li>
//            </ul>
//          </div>
...
//                className="w-full px-3 py-2 text-gray-700 rounded-l-md focus:outline-none"
//              />
...
//              <a href="#" className="hover:text-gray-100"><FaLinkedin size={20} /></a>
//            </div>
//          </div>
//        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-gray-100 transition">FAQ</a></li>
              <li><a href="#" className="hover:text-gray-100 transition">Return Policy</a></li>
              <li><a href="#" className="hover:text-gray-100 transition">Shipping Info</a></li>
            </ul>
          </div>
